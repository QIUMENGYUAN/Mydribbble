...
public class UserBucketsActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,RecyclerArrayAdapter.OnLoadMoreListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_buckets);
    ...
    private void dealWithAdapter(final RecyclerArrayAdapter<Bucket> adapter){
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                intent.setClass(UserBucketsActivity.this,BucketShotsActivity.class);
