...
package com.oddfeel.awesomedribbble.ui.MyLike;
...
public class MyLikeActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,RecyclerArrayAdapter.OnLoadMoreListener{
    ...
    private void dealWithAdapter(final RecyclerArrayAdapter<Like_Shots> adapter){
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Intent intent = new Intent(MyLikeActivity.this, ShotDetailActivity.class);
