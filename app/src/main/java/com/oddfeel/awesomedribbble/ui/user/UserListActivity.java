...
public class UserListActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,RecyclerArrayAdapter.OnLoadMoreListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("评论 喜欢 看过 收藏");
    ...
    private void dealWithAdapter(final RecyclerArrayAdapter<Bucket> adapter){
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                intent.setClass(UserListActivity.this,BucketShotsActivity.class);
